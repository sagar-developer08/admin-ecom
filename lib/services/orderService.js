...
export const orderService = {
  ...
  getCustomerOrderStats: async (customerId) => {
    return await cartApi.get(`/orders/admin/customer-stats/${customerId}`);
  },

  // Get customer orders
  getCustomerOrders: async (customerId, params = {}) => {
    return await cartApi.get(`/orders/admin/customer/${customerId}`, params);
  },

  // Get order metrics for dashboard
  getOrderMetrics: async (params = {}) => {
    return await cartApi.get('/orders/metrics', params);
  },
};
